...
export async function POST(req: Request) {
  ...
  try {
    ...
    const suggestionId = `${category}-${timestamp}`;

    // Log suggestion to external usage log (e.g., Google Sheets Apps Script).
    ...
    return NextResponse.json({ id: suggestionId, category: CATEGORY_LABELS[category] });
  } catch (e) {
